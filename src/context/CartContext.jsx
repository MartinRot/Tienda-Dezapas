...
export const CartProvider = ({ children }) => {
    ...
    const addItem = ( item, cantidad, setSinStock) => {
        ...
        if (cart.some ((p) => p.id === item.id)){
            ...
            if (repetido.cantidad + 1 >= repetido.stock){
                setSinStock(true)
            } 
    ...
    return (
        <CartContext.Provider value={{ cart, setCart, addItem, removeItem, clearCart, suma, resta, precioTotal, productosEnCarrito }} > 
            { children } 
